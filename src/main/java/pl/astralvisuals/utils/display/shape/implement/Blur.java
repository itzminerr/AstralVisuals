...
public class Blur implements Shape, QuickImports {
   private final class_10156 SHADER_KEY = new class_10156(class_2960.method_60655("minecraft", "core/blur"), class_290.field_1592, class_10149.field_53930);
   ...
   public void setup() {
      ...
      this.resolution.set(buffer.field_1482, buffer.field_1481);
   }
}
