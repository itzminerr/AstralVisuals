package pl.astralvisuals.commands.argument;
...
import pl.astralvisuals.utils.client.managers.api.command.datatypes.IDatatype;
import pl.astralvisuals.utils.client.managers.api.command.datatypes.IDatatypeContext;
import pl.astralvisuals.utils.client.managers.api.command.datatypes.IDatatypeFor;
import pl.astralvisuals.utils.client.managers.api.command.datatypes.IDatatypePost;
...
import pl.astralvisuals.utils.client.managers.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
   ...
   public ICommandArgument consumed() {
      return (ICommandArgument)(!this.consumed.isEmpty() ? this.consumed.getLast() : CommandArguments.unknown());
   }
